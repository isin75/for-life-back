...
CREATE TABLE "pomodoro_session" (
    ...
    "updated_at" TIMESTAMP(3) NOT NULL,
    "is_completed" BOOLEAN DEFAULT false,
    "pomodoro_session" TEXT NOT NULL,
...
-- AddForeignKey
ALTER TABLE "pomodoro_session" ADD CONSTRAINT "pomodoro_session_pomodoro_session_fkey" FOREIGN KEY ("pomodoro_session") REFERENCES "user"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "pomodoro_round" ADD CONSTRAINT "pomodoro_round_pomodoro_session_fkey" FOREIGN KEY ("pomodoro_session") REFERENCES "pomodoro_session"("id") ON DELETE CASCADE ON UPDATE CASCADE;
